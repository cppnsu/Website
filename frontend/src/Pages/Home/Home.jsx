    ...
    return (
      <div className="bg-transparent">
        <div className="relative h-screen min-h-full overflow-hidden bg-cover">
          <img
            src={data.data.getAbout[0].Gallery[0]}
            alt="gallery image"
            ...
            <div className="m-auto flex h-full w-full flex-col md:flex-row justify-center md:justify-between">
              ...
              <div className="w-5/6 md:w-2/5 h-1/2 m-auto flex flex-col mt-3 md:m-auto md:justify-center md:self-center">
                <p className="text-lg text-slate-100 drop-shadow text-center">
                  {data.data.getAbout[0].Description}
                </p>
                <button
              ...
              <div className="w-full bg-slate-100 opacity-95 flex flex-col justify-center">
                <div className="w-5/6 h-5/6 m-auto flex flex-col pb-12">
                  <h1 className="md:hidden text-5xl text-zinc-800 font-extrabold m-auto">
                    {data.data.getCultureNight[0].Japanese_title}
                  </h1>
                  <h1 className="md:hidden text-4xl text-zinc-800 m-auto">
                    {data.data.getCultureNight[0].English_romaji} -{" "}
                  </h1>
                  <h1 className="md:hidden text-4xl text-zinc-800 m-auto">
                    {data.data.getCultureNight[0].English_definition}
                  </h1>
                  <p className="md:hidden text-md text-zinc-800 mx-auto my-3">
                    {data.data.getCultureNight[0].Description}
                  </p>
